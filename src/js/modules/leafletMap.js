...
/**
 * Initializies the interactive Leaflet map
 *
 * @name leafletMap
 * @param {number} width
 * @param {number} height
...
/**
 * Add Stamen toner tile to leaflet map you could swap them out with tiles of your choice if you want to.
 *
 * @see http://leafletjs.com/reference.html#tilelayer-options
 * @param {L.map} map a Leaflet Map
 */
